    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      >
        ...
        <div className="p-8 text-center bg-gradient-to-r from-primary to-indigo-600">
          <div className="flex justify-center mb-4">
            <div className="p-4 border rounded-full shadow-lg bg-white/20 backdrop-blur-sm border-white/30">
              <UsersIcon className="text-white h-14 w-14" />
            </div>
          </div>
          <h1 className="text-2xl font-bold text-white">Sistem Peminjaman Buku</h1>
          <p className="mt-2 text-white/90">Daftar akun baru</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="relative mb-4">
            <label htmlFor="role" className="block mb-1 text-sm font-medium text-foreground">
              Peran
            </label>
            <div className="relative">
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="w-full py-3 pl-12 pr-4 transition-all duration-200 border rounded-lg appearance-none border-input focus:ring-2 focus:ring-primary/30 focus:border-primary bg-background hover:border-primary/30"
              >
                <option value="student">Siswa</option>
              </select>
              <div className="absolute text-gray-400 transform -translate-y-1/2 pointer-events-none left-4 top-1/2">
          ...
          {formData.role === 'student' && (
            <>
              <div className="relative mb-4">
                <label htmlFor="class" className="block mb-1 text-sm font-medium text-foreground">
                  Kelas
                </label>
                <input
                  type="text"
              ...
              <div className="relative mb-4">
                <label htmlFor="nisn" className="block mb-1 text-sm font-medium text-foreground">
          ...
          <div className="relative mb-6">
            <label htmlFor="address" className="block mb-1 text-sm font-medium text-foreground">
              Alamat
            </label>
            <input
              type="text"
          ...
          >
            <p className="text-sm text-muted-foreground">
              Sudah punya akun?{' '}
              <Link href="/login" className="font-medium transition-colors text-primary hover:text-primary/80 hover:underline">
                Masuk di sini
              </Link>
            </p>
          </motion.div>
